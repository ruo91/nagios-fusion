...
//
// $Id: header.inc.php 75 2010-04-01 19:40:08Z egalstad $
...
<?php
	// default logo stuff
	$logo="nagiosfusion-logo-small.png";
	$logo_alt=get_product_name();
	$logo_url="http://www.nagios.com/products/nagiosfusion/";
...
<?php
	if(is_authenticated()==true && user_has_agreed_to_license()==true  && get_pageopt('')!='forcepasswordchange') {
...
if (strpos($filename, "html/admin")) {
	...
	$active = "dashboards";
} else if (strpos($filename, "html/config")) {
	$active = "configure";
