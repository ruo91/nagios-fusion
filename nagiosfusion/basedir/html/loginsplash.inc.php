...
/**
*	This file can be modified for use as a custom login splash page for Nagios Fusion
...
<h3><?php echo gettext("About Nagios Fusion"); ?></h3>
<p>
<?php echo gettext("Nagios Fusion is a powerful enterprise dashboard for visualizing IT infrastructure status and enabling faster problem resolution across an organization's entire IT infrastructure.	For more information on Nagios Fusion, visit"); ?>
<a href="http://www.nagios.com/products/nagiosfusion/" target="_blank">www.nagios.com/products/nagiosfusion/</a>
</p>
<h3><?php echo gettext("Nagios Learning Opportunities"); ?></h3>
<p>
<?php echo gettext("Learn about Nagios"); ?> <a href="http://www.nagios.com/services/training" target="_blank">
<strong><?php echo gettext("training"); ?>
</strong></a> <?php echo gettext("and"); ?> <a href="http://www.nagios.com/services/certification" target="_blank">
...
<a href="http://go.nagios.com/nwcna" target="_blank">
<strong><?php echo gettext("Nagios World Conference"); ?></strong></a>.
</p>
