...
?>
	...
	<p>
	<?php echo gettext("An email will be sent to"); ?>: <b><?php echo $email;?></b>
	</p>
	<p>
	<a href="<?php echo get_base_url()."account/?fusionwindow=main.php";?>" target="_top"><b><?php echo gettext("Change your email address"); ?></b></a>
	</p>
...
function do_test(){
	...
	if($test_email==true){
		...
		$subject=gettext("Nagios XI Email Test");
		$message=gettext("This is a test email from Nagios XI");
		...
		$output[]=gettext("A test email was sent to")." <b>".$email."</b>";
		$output[]="----";
		
		$output[]=gettext("Mailer said").": <b>".$debugmsg."</b>";
		
		// check for errors
		if($result==false){
			$output[]=gettext("An error occurred sending a test email!");
