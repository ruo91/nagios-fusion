...
?>
	...
	<div class="sectionTitle"><?php echo gettext("Auto-Login Settings"); ?></div>
	
	<table>

	<tr>
	<td>
	<label><?php echo gettext("Enable Auto-Login"); ?>:</label><br class="nobr" />	
	</td>
	<td>
	...
	<tr>
	<td>
	<label><?php echo gettext("Account"); ?>:</label><br class="nobr" />	
	</td>
	<td>
